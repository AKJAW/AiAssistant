...
class DashboardScreenStateHolder(
    ...
    private val chatScreenStateHolder: ChatMessageHandler = Dependencies.chatMessageHandler,
) {
...
fun DashboardScreen(initialType: ChatType?) {
    ...
    Column(modifier = Modifier.padding(horizontal = 8.dp)) {
        ...
        Box {
            ...
            Text(BuildInfo.version, modifier = Modifier.align(Alignment.TopEnd).alpha(0.3f))
        }
        Spacer(modifier = Modifier.height(4.dp))
        HorizontalPager(
            state = pagerState,
